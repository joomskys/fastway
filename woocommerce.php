...
if( (class_exists( 'WooCommerce' ) && is_shop()) || (class_exists( 'WooCommerce' ) && is_product_category()) ) {
    $sidebar_pos = (isset($_GET['sidebar-shop'])) ? trim($_GET['sidebar-shop']) : fastway_get_opt( 'sidebar_shop', 'right' );
} else {
    $sidebar_pos = 'none';
}
?>
    <div class="container content-container">
        <div class="row content-row">
            ...
            <?php if ( is_active_sidebar( 'sidebar-shop' ) && 'left' == $sidebar_pos || is_active_sidebar( 'sidebar-shop' ) && 'right' == $sidebar_pos ) : ?>
                <aside id="secondary"<?php fastway_secondary_class( $sidebar_pos, 'sidebar-fixed widget-area' ); ?>>
