...
<div id="<?php echo esc_attr($html_id) ?>" class="cms-post-carousel cms-slick-slider">
                ...
                <div class="carousel-item-inner">
                    ...
                    <div class="entry-body">
                        ...
                        <div class="entry-readmore">
                            <a class="btn elementor-animation-<?php echo esc_attr($settings['hover_animation']); ?>" href="<?php echo esc_url(get_permalink( $post->ID )); ?>"><?php echo esc_html__($settings['button_text'], 'fastway'); ?></a>
                        </div>
                        <?php endif; ?>
                    </div>
                </div>
