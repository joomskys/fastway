...
if(!empty($toggles)) : ?>
<div id="<?php echo esc_attr($html_id); ?>" class="cms-toggle">
    <?php foreach ($toggles as $key => $value):
        ...
        <<?php etc_print_html($title_html_tag); ?> class="cms-toggle-title <?php echo esc_attr($is_active?'active':''); ?>" data-target="<?php echo esc_attr('#' . $_id); ?>">
