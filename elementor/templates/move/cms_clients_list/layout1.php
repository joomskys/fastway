...
<?php if(isset($settings['clients']) && !empty($settings['clients']) && count($settings['clients'])): ?>
    <div class="cms-clients-list-wrapper cms-slick-slider">
                    ...
                    <div class="cms-client-wrapper">
                        <div class="client-image">
                            ...
                            if(!empty($client['client_image']['id'])){
                                ...
                                ?>
                                <img src="<?php echo esc_url($client['client_image']['url']); ?>" alt="<?php echo esc_html($client['client_name']); ?>">
                                <?php
                            }
                            ?>
                        </div>
                        <div class="client-name">
                            ...
                            ?>
                            <a href="<?php echo esc_url($url); ?>" <?php etc_print_html($target?'target="_blank"':''); ?> <?php etc_print_html($rel?'rel="nofollow"':''); ?>><?php echo esc_html($client['client_name'])?></a>
                        </div>
                    </div>
                </div>
                <?php endforeach; ?>
