            ...
            <div class="main-slider style-two default-banner">
                <div class="tp-banner-container">
                    <div class="tp-banner">
                        ...
                        <div class="rev_slider_wrapper fullscreen-container" data-alias="typewriter-effect" data-source="gallery" style="background:#212427;">
                           <div id="rev_slider_1014_1" class="rev_slider fullscreenbanner" style="display:none;" data-version="5.4.1">
                                <ul>
                                    <!-- SLIDE 1 -->    
                                    <li data-index="rs-1000" data-transition="fadethroughdark" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="default" data-easeout="default" data-masterspeed="2000"  data-thumb="<?php echo esc_url(get_template_directory_uri().'/elementor/templates/widgets/cms_revslider_html/construct-video1.jpg'); ?>"  data-rotate="0"  data-saveperformance="off"  data-title="Creative" data-param1="01" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
                                    
                                    <!-- MAIN IMAGE -->
                                    <img src="<?php echo esc_url(get_template_directory_uri().'/elementor/templates/widgets/cms_revslider_html/construct-video1.jpg'); ?>"  alt="fastway"  data-bgposition="center center" data-bgfit="cover" class="rev-slidebg" data-no-retina/>
                                    <!-- LAYERS -->
                                    ...
                                    style="z-index: 12;background-color:rgba(0, 0, 0, 0.6);border-color:rgba(0, 0, 0, 0);border-width:0px;"> 
                                    </div>
                                    ...
                                    data-videomp4="<?php echo esc_url(get_template_directory_uri().'/elementor/templates/widgets/cms_revslider_html/construct-video1.mp4');?>" 
                                    ...
                                    data-x="['left','left','left','left']" data-hoffset="['250','180','150','100']" 
                                    ...
                                    <span style="font-family: 'Roboto', sans-serif;">
                                        <span class="text-accent text-uppercase">Transport </span>
                                    </span>
                                    </div>
                                    ...
                                    data-x="['left','left','left','left']" data-hoffset="['650','550','400','250']" 
                                    data-y="['top','top','top','top']" data-voffset="['300','300','300','300']"  
                                    data-width="none"
                                    data-height="none"
                                    data-fontsize="['60','60','40','24']"
                                    ...
                                    color: rgba(255, 255, 255, 1.00);
                                    border-width:0px;">
                                    <span class="text-uppercase" style="font-family: 'Roboto', sans-serif;">By Air</span>
                                    </div>
                                    ...
                                    color: rgba(255, 255, 255, 1.00);
                                    border-width:0px;">
                                    <span class="text-uppercase" style="font-family: 'Roboto', sans-serif;">By Oversea</span>
                                    </div>                            
                                    ...
                                    color: rgba(255, 255, 255, 1.00);
                                    border-width:0px;">
                                    <span class="text-uppercase" style="font-family: 'Roboto', sans-serif;">By Road</span>
                                    </div>  
                                    ...
                                    color: rgba(255, 255, 255, 1.00);
                                    border-width:0px;">
                                    <span class="text-uppercase" style="font-family: 'Roboto', sans-serif; ">By Train</span>
                                    </div>                              
