...
?>
<div class="cms-icon-box-wrapper cms-icon-box-layout13 bdr-0 p-30 hover-border hover-border-outer bg-white cms-transition">
    <?php if ( $has_icon ) : ?>
    <div class="cms-icon m-b5 icon-sm text-accent">
    ...
    <div class="cms-icon-box-content">
        <div class="h4 cms-icon-box-title p-t10 m-b15">
