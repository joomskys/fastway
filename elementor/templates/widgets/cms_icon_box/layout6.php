...
?>
<div class="cms-icon-box-wrapper text-start p-10 cms-icon-box-layout6">
    <div class="row gutters-10">
        <?php if ( $has_icon ) : ?>
        <div class="cms-icon col-auto maxw-60 init">
        ...
        <?php endif; ?>
        <div class="cms-icon-box-content col depend-maxw">
            <div class="h4 cms-icon-box-title m-0">
