...
?>
<div class="cms-icon-box-wrapper cms-icon-box-layout11 p-30 bg-white hover-border-outer hover-border bdr-0">
    <div class="row gutters-10">
        <?php if ( $has_icon ) : ?>
        <div class="cms-icon-box-icon cms-icon-md m-b15 col-auto text-accent text-center">
