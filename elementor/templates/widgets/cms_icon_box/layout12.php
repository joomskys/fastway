...
?>
<div class="cms-icon-box-wrapper cms-icon-box-layout12 bdr-1 bdr-gray-white p-30 hover-border hover-border-outer bg-hover-secondary cms-transition">
    <?php if ( $has_icon ) : ?>
    <div class="cms-icon m-b5 icon-sm text-white">
    ...
    <div class="cms-icon-box-content">
        <div class="h4 cms-icon-box-title p-t10 m-b15 text-accent text-hover-white">
