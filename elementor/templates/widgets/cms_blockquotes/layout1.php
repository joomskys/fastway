...
?>
<div id="<?php echo esc_attr($html_id); ?>" class="cms-blockquotes-wrapper cms-blockquotes-layout1">
    <blockquote>
        <span <?php etc_print_html($widget->get_render_attribute_string( 'content_text' )); ?>><?php echo wp_kses_post( nl2br($content_text) ); ?></span>
        <cite <?php etc_print_html($widget->get_render_attribute_string( 'title_text' )); ?>><?php echo esc_html($title_text); ?></cite>
    </blockquote>
</div>