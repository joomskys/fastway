...
?>
<div <?php fastway_elementor_layout_mode_settings_render_attrs($widget, $settings);?>>
    <?php
    switch ($settings['layout_mode']) {
        ...
        ?>
            <div <?php fastway_slick_slider_settings($widget); ?>>
                <?php
                    $load_more['tax'] = $tax;
                    fastway_elementor_get_service($posts, $load_more, $widget, ['inner_class' => 'cms-overlay-slideup bg-white', 'show_readmore' => '1']);
                ?>
            </div>
        <?php
            break;
    ...
    fastway_elementor_button_render($widget, $settings, ['class' => 'm-t30 text-center']);
    ?>
</div>