...
<div class="cms-pricing-wrap cms-pricing-3 bg-secondary cms-block-shadow text-center">
    <div class="cms-pricing-inner bg-gray">
        ...
        <?php if($settings['pricing_table_title_switcher'] == 'true') : ?>
            <div class="cms-pricing-title cms-heading h3 bg-secondary">
        ...
        <?php if($settings['pricing_table_button_switcher'] == 'true') : ?>
            <div class="cms-pricing-button-wrap bg-secondary">
                <a class="cms-pricing-button btn text-white m-t5" href="<?php echo esc_url( $link_url ); ?>" target="<?php echo esc_attr($target); ?>" rel="<?php echo esc_attr($rel); ?>">
