...
<div class="cms-pricing-wrap bg-secondary cms-block-shadow text-center">
    <div class="cms-pricing-inner bg-gray">
        ...
        <?php if($settings['pricing_table_button_switcher'] == 'true') : ?>
            <div class="cms-pricing-button-wrap bg-secondary">
                <a class="cms-pricing-button btn text-white m-t25" href="<?php echo esc_url( $link_url ); ?>" target="<?php echo esc_attr($target); ?>" rel="<?php echo esc_attr($rel); ?>">
