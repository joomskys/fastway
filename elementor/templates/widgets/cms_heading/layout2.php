...
?>
<div class="custom-heading-wrapper cms-heading-layout2">
    ...
    <<?php etc_print_html($settings['heading_size']); ?> class="custom-heading">
        <<?php echo implode( ' ', [ $icon_tag, $link_attributes ] ); ?><?php etc_print_html($widget->get_render_attribute_string( 'heading_text' )); ?>><?php echo esc_html($settings['heading_text']); ?></<?php etc_print_html($icon_tag); ?>>
