...
?>
<div class="cms-counter-wrapper cms-counter-layout4 text-center text-black bg-white p-20">
    ...
    <?php endif; ?>
    <div class="cms-counter-number-wrapper text-24 font-800 m-b10 text-accent">
