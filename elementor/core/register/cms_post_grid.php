...
etc_add_custom_widget(
    array(
        'name' => 'cms_post_grid',
        'title' => esc_html__( 'CMS Post Grid', 'fastway' ),
            ...
            'sections' => array(
                ...
                array(
                    ...
                    'controls' => array(
                        ...
                        array(
                            'name' => 'col_xs',
                            'label' => esc_html__( 'Columns XS Devices', 'fastway' ),
                            'type' => \Elementor\Controls_Manager::SELECT,
                            'default' => '1',
                            'options' => [
                                '1' => esc_html__( '1', 'fastway' ),
                                '2' => esc_html__( '2', 'fastway' ),
                                '3' => esc_html__( '3', 'fastway' ),
                                '4' => esc_html__( '4', 'fastway' ),
                                '6' => esc_html__( '6', 'fastway' ),
                                '12' => esc_html__( '12', 'fastway' ),
                            ],
                        ),
                        array(
                            'name' => 'col_sm',
